...
app.config['JWT_SECRET_KEY'] = os.environ.get('JWT_SECRET_KEY', 'hostel-super-secret-key-2024')
app.config['JWT_ACCESS_TOKEN_EXPIRES'] = timedelta(hours=24)  # stay logged in for 24 hours
...
with app.app_context():
    ...
    if not User.query.filter_by(role='admin').first():
        admin = User(username='admin', email='admin@hostelhub.com', role='admin')
    ...
    if Room.query.count() == 0:
        rooms = [
            ...
            Room(room_number="103", room_type="Single",    capacity=1, price=5000,  status="Available", description="Comfortable single room with study desk"),
            ...
            Room(room_number="202", room_type="Double",    capacity=2, price=8000,  status="Available", description="Spacious double room with shared bathroom"),
            Room(room_number="301", room_type="Triple",    capacity=3, price=10000, status="Available", description="Triple room ideal for groups"),
            Room(room_number="302", room_type="Triple",    capacity=3, price=10000, status="Available", description="Triple room with common study area"),
