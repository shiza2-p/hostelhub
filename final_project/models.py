...
class Room(db.Model):
    ...
    room_type   = db.Column(db.String(50),  nullable=True)   # Single | Double | Triple | Dorm
    ...
    def update_status(self):
        ...
        occupied = Student.query.filter_by(room_id=self.id).count()
...
class Student(db.Model):
    ...
    # Relationships to fee and complaint records
...
class Fee(db.Model):
    ...
    description = db.Column(db.String(200), nullable=False)   # e.g. "Monthly Rent – May 2026"
...
class Complaint(db.Model):
    ...
    category    = db.Column(db.String(50),  nullable=True)    # Maintenance | Noise | Food | Other
